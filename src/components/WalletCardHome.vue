...
<template>
  <section class="px-5 md:px-20 lg:gap-20 gap-5 grid py-5 md:py-10 grid-cols-12 w-full min-h-[50rem] overflow-hidden mt-5 md:mt-10 lg:mt-28">
    <!-- Section "Laissez-moi donner vie à vos projets" -->
