...
const App = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-9be42ff4"]]);
const _sfc_main$r = {};
...
const IconBars = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["ssrRender", _sfc_ssrRender$b]]);
const _sfc_main$q = {};
...
const IconClose = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["ssrRender", _sfc_ssrRender$a]]);
const _sfc_main$p = {};
...
const IconInstagram = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["ssrRender", _sfc_ssrRender$9]]);
const _sfc_main$o = {};
...
const IconX = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$n = {};
...
const IconArrowGrowUp = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["ssrRender", _sfc_ssrRender$7]]);
...
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(_attrs)} data-v-abe087aa><nav class="" data-v-abe087aa><ul class="fixed px-5 md:px-20 bg-white shadow-md backdrop-blur-sm items-center w-full flex justify-between py-3 space-x-5 z-header" data-v-abe087aa><li class="cursor-pointer" data-v-abe087aa>`);
      ...
      _push(`</li><li data-v-abe087aa><ul class="flex space-x-10" data-v-abe087aa><li class="cursor-pointer hidden md:flex" data-v-abe087aa><ul class="flex space-x-7 text-lg" data-v-abe087aa><li class="border-b-4 py-3 border-transparent hover:border-b-black transition" data-v-abe087aa> Components </li><li class="border-b-4 py-3 border-transparent hover:border-b-black transition" data-v-abe087aa> Recents articles </li><li class="border-b-4 py-3 border-transparent" data-v-abe087aa>`);
      _push(ssrRenderComponent(IconInstagram, { class: "w-7 h-7 relative z-10" }, null, _parent));
      _push(`</li><li class="border-b-4 py-3 border-transparent" data-v-abe087aa>`);
      _push(ssrRenderComponent(IconX, { class: "w-7 h-7 relative z-10" }, null, _parent));
      _push(`</li></ul></li><li class="md:border-b-4 cursor-pointer py-3 border-transparent" data-v-abe087aa>`);
      _push(ssrRenderComponent(IconBars, { class: "text-black w-8 h-8 relative z-10" }, null, _parent));
      _push(`</li></ul></li></ul></nav><div data-v-abe087aa><div class="container container--menu bg-white/40 h-full backdrop-blur-md flex justify-between px-5 md:px-10 lg:px-20 py-10" data-v-abe087aa><div class="sidebar" data-v-abe087aa><button class="sidebar__menu-trigger menu__right" data-v-abe087aa>`);
      _push(ssrRenderComponent(IconClose, { class: "w-10 h-10" }, null, _parent));
      _push(`</button></div><div class="menu__layout" data-v-abe087aa><ul class="menu__left text-xl space-y-5" data-v-abe087aa><!--[-->`);
      ssrRenderList(menuItems, (item) => {
        _push(`<li class="menu-item" data-v-abe087aa>`);
        _push(ssrRenderComponent(_component_router_link, {
          to: item.route,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="icon" data-v-abe087aa${_scopeId}>`);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["__scopeId", "data-v-abe087aa"]]);
const _sfc_main$k = {};
...
const twitter = "/assets/logo-twitter-D8TzkRKf.png";
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main class="relative"><div class="absolute z-0 inset-0 h-full w-full bg-[radial-gradient(theme(colors.green.300)_1px,transparent_1px)] [background-size:16px_16px]"></div><section class="grid relative z-40 grid-cols-12 px-5 md:px-20 py-5"><div class="col-span-12 md:col-span-6"><h2 class="text-5xl">Crafting the Future of Web Interfaces</h2></div><div class="col-span-12 md:col-span-6 mt-8 md:mt-0"><p class="text-lg md:text-xl"> As a frontend developer, I blend creativity with precision to build intuitive and dynamic web applications. From pixel-perfect designs to seamless user experiences, I turn ideas into interactive realities, using modern technologies like Vue.js, Nuxt.js, and TailwindCSS. My mission? Delivering fast, responsive, and aesthetically compelling solutions that make a lasting impact. </p></div></section>`);
